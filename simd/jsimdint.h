...
DEFINE_SIMD_EXTRGB_COLOR_CONVERTERS(ycc, hvx)
DEFINE_SIMD_EXTRGB_COLOR_CONVERTERS(gray, hvx)
...
DEFINE_SIMD_EXTRGB_COLOR_DECONVERTERS(hvx)
...
EXTERN(void) jsimd_h2v1_downsample_hvx
  (JDIMENSION image_width, int max_v_samp_factor, JDIMENSION v_samp_factor,
   JDIMENSION width_in_blocks, JSAMPARRAY input_data, JSAMPARRAY output_data);
EXTERN(void) jsimd_h2v2_downsample_hvx
  (JDIMENSION image_width, int max_v_samp_factor, JDIMENSION v_samp_factor,
   JDIMENSION width_in_blocks, JSAMPARRAY input_data, JSAMPARRAY output_data);
...
EXTERN(void) jsimd_h2v1_upsample_hvx
  (int max_v_samp_factor, JDIMENSION output_width, JSAMPARRAY input_data,
   JSAMPARRAY *output_data_ptr);
EXTERN(void) jsimd_h2v2_upsample_hvx
  (int max_v_samp_factor, JDIMENSION output_width, JSAMPARRAY input_data,
   JSAMPARRAY *output_data_ptr);
...
EXTERN(void) jsimd_h2v1_fancy_upsample_hvx
  (int max_v_samp_factor, JDIMENSION downsampled_width, JSAMPARRAY input_data,
   JSAMPARRAY *output_data_ptr);
EXTERN(void) jsimd_h2v2_fancy_upsample_hvx
  (int max_v_samp_factor, JDIMENSION downsampled_width, JSAMPARRAY input_data,
   JSAMPARRAY *output_data_ptr);
EXTERN(void) jsimd_h1v2_fancy_upsample_hvx
  (int max_v_samp_factor, JDIMENSION downsampled_width, JSAMPARRAY input_data,
   JSAMPARRAY *output_data_ptr);
...
DEFINE_SIMD_EXTRGB_MERGED_UPSAMPLERS(h2v1, hvx)
DEFINE_SIMD_EXTRGB_MERGED_UPSAMPLERS(h2v2, hvx)
...
EXTERN(void) jsimd_convsamp_hvx
  (JSAMPARRAY sample_data, JDIMENSION start_col, DCTELEM *workspace);
...
EXTERN(void) jsimd_fdct_islow_hvx(DCTELEM *data);
EXTERN(void) jsimd_fdct_ifast_hvx(DCTELEM *data);
...
EXTERN(void) jsimd_quantize_hvx
  (JCOEFPTR coef_block, DCTELEM *divisors, DCTELEM *workspace);
...
EXTERN(void) jsimd_idct_islow_hvx
  (void *dct_table, JCOEFPTR coef_block, JSAMPARRAY output_buf,
   JDIMENSION output_col);
EXTERN(void) jsimd_idct_ifast_hvx
  (void *dct_table, JCOEFPTR coef_block, JSAMPARRAY output_buf,
   JDIMENSION output_col);
...
EXTERN(void) jsimd_idct_2x2_hvx
  (void *dct_table, JCOEFPTR coef_block, JSAMPARRAY output_buf,
   JDIMENSION output_col);
EXTERN(void) jsimd_idct_4x4_hvx
  (void *dct_table, JCOEFPTR coef_block, JSAMPARRAY output_buf,
   JDIMENSION output_col);
...
EXTERN(void) jsimd_encode_mcu_AC_first_prepare_hvx
  (const JCOEF *block, const int *jpeg_natural_order_start, int Sl, int Al,
   UJCOEF *values, size_t *zerobits);
EXTERN(int) jsimd_encode_mcu_AC_refine_prepare_hvx
  (const JCOEF *block, const int *jpeg_natural_order_start, int Sl, int Al,
   UJCOEF *absvalues, size_t *bits);
